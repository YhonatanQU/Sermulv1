...
if(isset($_POST['edit_cat'])){
  ...
  if(empty($errors)){
        $sql = "UPDATE categories SET name='{$cat_name}', ShortName='{$cat_type}', Numbe='{$cat_number}'";
     ...
     <div class="panel panel-default">
       ...
       <div class="panel-body">
         <form method="post" action="edit_categorie.php?id=<?php echo (int)$categorie['id'];?>">
           ...
           <div class="form-group">
               <input type="text" class="form-control" name="categorie-type" value="<?php echo remove_junk(ucfirst($categorie['ShortName']));?>">
           </div>
           <div class="form-group">
               <input type="text" class="form-control" name="categorie-number" value="<?php echo remove_junk(ucfirst($categorie['Numbe']));?>">
           </div>
